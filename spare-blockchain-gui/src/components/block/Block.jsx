...
import { mojo_to_spare } from '../../util/spare';
...
export default function Block() {
  ...
  const poolReward = mojo_to_spare(calculatePoolReward(blockRecord.height));
  const baseFarmerReward = mojo_to_spare(calculateBaseFarmerReward(blockRecord.height));

  const spareFees = blockRecord.fees
    ? mojo_to_spare(BigInt(blockRecord.fees))
    : '';
