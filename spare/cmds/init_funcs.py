...
from spare.ssl.create_ssl import generate_ca_signed_cert, get_spare_ca_crt_key, make_ca_cert
...
def create_all_ssl(root: Path):
    ...
    spare_ca_crt_path.write_bytes(spare_ca_crt)
    spare_ca_key_path.write_bytes(spare_ca_key)
