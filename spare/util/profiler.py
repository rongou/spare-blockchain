...
# the output will be printed to your spare root path, e.g. ~/.spare/mainnet/profile/
# to analyze the profile, run:

#   python spare/utils/profiler.py ~/.spare/mainnet/profile | less -r
...
#   python spare/utils/profiler.py ~/.spare/mainnet/profile 10 20
...
if __name__ == "__main__":
    ...
    def analyze_slot_range(profile_dir: pathlib.Path, first: int, last: int):
        ...
        output_file = "spare-hotspot-%d" % first
        if first < last:
            output_file += "-%d" % last
